...
(function() {
    ...
    if (!styles) {
        ...
        styles.textContent += [
            '.sh-chat-fab{width:clamp(54px,5vw,68px);height:clamp(54px,5vw,68px);background:radial-gradient(circle at 30% 28%,#8f3556 0%,#6f1733 38%,#4f1124 100%);box-shadow:0 20px 44px rgba(79,17,36,.42),inset 0 2px 7px rgba(255,255,255,.22),inset 0 -10px 16px rgba(0,0,0,.24)}',
            ...
            '.sh-chat-teaser{position:fixed;right:22px;bottom:calc(106px + var(--sh-chat-offset-bottom,0px));max-width:240px;padding:12px 14px;border-radius:18px;border:1px solid rgba(255,255,255,.55);background:linear-gradient(145deg,rgba(255,255,255,.98),rgba(248,241,233,.92));color:#4f1124;font-size:12px;font-weight:800;line-height:1.55;box-shadow:0 18px 40px rgba(15,23,42,.15),inset 0 1px 0 rgba(255,255,255,.8);backdrop-filter:blur(16px);z-index:99997;transform-origin:bottom right;transition:opacity .22s ease,transform .22s ease,bottom .22s ease}',
            ...
            '@media (max-width:640px){.sh-chat-window{border-radius:24px}.sh-chat-fab{width:54px;height:54px}.sh-chat-teaser{right:12px;left:12px;max-width:none;bottom:calc(78px + var(--sh-chat-offset-bottom,0px))}.sh-chat-toolbar{padding:10px 14px;align-items:flex-start;flex-direction:column}.sh-chat-window::after{display:none}}'
        ].join('');
